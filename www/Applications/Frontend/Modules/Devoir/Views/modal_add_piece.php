<form method="post" action="/devoirs/consulter-<?php echo $devoir->id()?>" enctype="multipart/form-data">
	<div class="modal hide fade" id="AddPiece" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
