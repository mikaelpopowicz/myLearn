<div class="row">
	<div class="col-lg-12">
		<ol class="breadcrumb">
			...
			<li class="active">Modifier <?php echo $devoir->libelle()?></li>
		</ol>
	</div>
</div>
					...
					<li>
						<div class="text-center">
							...
							<ul class="list-inline">
								<li>
									<button type="submit" name="modifier" class="btn btn-large btn-primary">Modifier</button>
								</li>
								<li>
		...
		<div class="col-md-9">
			<section id="titre">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="classe" id="classe" class="form-control readonly" readonly>
							<?php
							echo "<option value='".base64_encode(serialize($devoir->classe()))."' >".$devoir->classe()->libelle()."</option>";
							?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<textarea rows="15" id="contenu" name="enonce" class="form-control"><?php echo isset($devoir['enonce']) ? $devoir->enonce() : "";?></textarea>
						<?php
						if (isset($erreurs) && in_array(\Library\Entities\Devoir::ENONCE_INVALIDE, $erreurs))
							{
								echo '<span class="help-block">L\'énoncé ne peut être vide.</span>';
							}
						?>
					</div>
				</div>
