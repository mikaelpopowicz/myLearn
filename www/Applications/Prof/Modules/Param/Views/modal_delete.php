<form method="post" action="/professeur/cours/supprimer">
	<div class="modal fade" id="modalDeleteCours" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
