<form method="post" action="/admin/classes/supprimer">
	<div class="modal fade" id="modalDeleteClasse" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p class="text-danger"><strong>ATTENTION, la suppression d'une classe entraine la supression de tous ses cours et devoirs !</strong><p>
					<p>Êtes-vous sur de vouloir supprimer la(es) classe(s) suivante(s) :</p>
			<ul>
				<?php
				$i = 0;
